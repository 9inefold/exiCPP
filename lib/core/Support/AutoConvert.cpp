...
std::error_code exi::disablezOSAutoConversion(int FD) {
...
std::error_code exi::enablezOSAutoConversion(int FD) {
...
std::error_code exi::restorezOSStdHandleAutoConversion(int FD) {
...
std::error_code exi::setzOSFileTag(int FD, int CCSID, bool Text) {
  exi_assert((!Text || (CCSID != FT_UNTAGGED && CCSID != FT_BINARY)),
...
ErrorOr<__ccsid_t> exi::getzOSFileTag(const char *FileName, const int FD) {
...
ErrorOr<bool> exi::needzOSConversion(const char *FileName, const int FD) {
