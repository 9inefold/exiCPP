...
public final class Transmogrifier2 {
   ...
   * @throws TransmogrifierException
   */
  public Transmogrifier2(SAXParserFactory saxParserFactory) throws TransmogrifierRuntimeException {
    this(saxParserFactory, false);
  }
  
  Transmogrifier2(boolean namespacePrefixesFeature) throws TransmogrifierRuntimeException {
    this(createSAXParserFactory(), namespacePrefixesFeature);
  }

  Transmogrifier2(SAXParserFactory saxParserFactory, boolean namespacePrefixesFeature) throws TransmogrifierRuntimeException {
