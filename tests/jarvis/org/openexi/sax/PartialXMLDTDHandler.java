//===- openexi/PartialXMLDTDHandler.java ----------------------------===//
//
 ...
 */
public interface PartialXMLDTDHandler {
   ...
   */
  default public void startDTD(XMLLocator locator, Augmentations augmentations)
      throws XNIException {
  }
   ...
   * normalization performed, or null if no default value is specified.
   * @param augmentations Additional information that may include infoset
   *                      augmentations.
   *
   * @throws XNIException Thrown by handler to signal an error.
   ...
   * @throws XNIException Thrown by handler to signal an error.
   */
  default public void endDTD(Augmentations augmentations) throws XNIException  {
  }

} // interface PartialXMLDTDHandler()
