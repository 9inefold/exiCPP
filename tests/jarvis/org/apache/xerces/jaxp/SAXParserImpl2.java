...
public class SAXParserImpl2
    extends javax.xml.parsers.SAXParser implements JAXPConstants, PSVIProvider {
   ...
   */
  SAXParserImpl2(SAXParserFactoryImpl2 spf, Hashtable features) throws SAXException {
   ...
   * @param features Hashtable of SAX features, may be null
   */
  SAXParserImpl2(SAXParserFactoryImpl2 spf, Hashtable features, boolean secureProcessing)
      throws SAXException {
    // Instantiate a SAXParser directly and not through SAX so that we use the
    // right ClassLoader
    ...
    if (grammar != null) {
      ...
      if (grammar instanceof XSGrammarPoolContainer) {
        ...
        fSchemaValidatorComponentManager = new SchemaValidatorConfiguration(
   ...
   * this class.
   */
  public XMLReader getXMLReader() { return xmlReader; }
  ...
  public Schema getSchema() { return grammar; }
  ...
  public static class JAXPSAXParser extends org.apache.xerces.parsers.SAXParser {
    private final HashMap<String, Object> fInitFeatures = new HashMap<String, Object>();
    private final HashMap<String, Object> fInitProperties = new HashMap<String, Object>();
    private final SAXParserImpl2 fSAXParser;
        ...
        if (JAXP_SCHEMA_LANGUAGE.equals(name)) {
          ...
          if (fSAXParser.grammar != null) {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(
                fConfiguration.getLocale(), "schema-already-specified",
                new Object[] {name}));
          }
          if (W3C_XML_SCHEMA.equals(value)) {
            // None of the properties will take effect till the
            // setValidating(true) has been called
            if (fSAXParser.isValidating()) {
              ...
              if (!fInitProperties.containsKey(JAXP_SCHEMA_LANGUAGE)) {
                fInitProperties.put(JAXP_SCHEMA_LANGUAGE,
          ...
          if (val != null && W3C_XML_SCHEMA.equals(val)) {
            if (!fInitProperties.containsKey(JAXP_SCHEMA_SOURCE)) {
              fInitProperties.put(JAXP_SCHEMA_SOURCE,
                                  super.getProperty(JAXP_SCHEMA_SOURCE));
            }
            super.setProperty(name, value);
          } else {
            throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(
                fConfiguration.getLocale(), "jaxp-order-not-supported",
      ...
      // This should never be thrown from the schema validator.
        ...
        if (e.getType() == XMLConfigurationException.NOT_RECOGNIZED) {
          throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(
              fConfiguration.getLocale(), "feature-not-recognized",
              new Object[] {identifier}));
        } else {
          throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(
              fConfiguration.getLocale(), "feature-not-supported",
              new Object[] {identifier}));
        }
      }
    }
    ...
    private void setSchemaValidatorProperty(String name, Object value)
      ...
      // This should never be thrown from the schema validator.
        ...
        if (e.getType() == XMLConfigurationException.NOT_RECOGNIZED) {
          throw new SAXNotRecognizedException(SAXMessageFormatter.formatMessage(
              fConfiguration.getLocale(), "property-not-recognized",
              new Object[] {identifier}));
        } else {
          throw new SAXNotSupportedException(SAXMessageFormatter.formatMessage(
              fConfiguration.getLocale(), "property-not-supported",
              new Object[] {identifier}));
        }
      }
    }
