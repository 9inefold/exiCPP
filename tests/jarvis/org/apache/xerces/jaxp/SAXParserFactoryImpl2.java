...
public class SAXParserFactoryImpl2 extends SAXParserFactory {
   ...
   * <code>SAXParser</code> using the currently
  ...
  public SAXParser newSAXParser() throws ParserConfigurationException {
    ...
    try {
      saxParserImpl = new SAXParserImpl2(this, features, fSecureProcess);
   ...
   */
  private SAXParserImpl2 newSAXParserImpl() throws ParserConfigurationException,
                                                   SAXNotRecognizedException,
                                                   SAXNotSupportedException {

    SAXParserImpl2 saxParserImpl;
    try {
      saxParserImpl = new SAXParserImpl2(this, features);
  ...
  /**
   * Sets the particular feature in the underlying
  ...
  public void setFeature(String name, boolean value) throws ParserConfigurationException,
    ...
    // If this is the secure processing feature,
    // save it then return.
    if (name.equals(XMLConstants.FEATURE_SECURE_PROCESSING)) {
      fSecureProcess = value;
      return;
    }
    // Keep built-in settings in synch with the
    // feature values.
    ...
    // XXX This is ugly.  We have to collect the
  ...
  /**
   * returns the particular property requested for
  ...
  public boolean getFeature(String name) throws ParserConfigurationException,
    ...
    // Check for valid name by creating a dummy
    // XMLReader to get feature value
  ...
  public void setXIncludeAware(boolean state) { this.isXIncludeAware = state; }
}
