...
function(_deref_target_alias target out)
  get_target_property(target_alias ${target} ALIASED_TARGET)
  if("${target_alias}" STREQUAL "tgt_alias-NOTFOUND")
    set(${out} ${target} PARENT_SCOPE)
  else()
    set(${out} ${target_alias} PARENT_SCOPE)
  endif()
endfunction(_deref_target_alias)
...
function(dump_target_properties target)
  _deref_target(${target} real_target)
  set(PROP_LIST "")
  foreach(prop $ENV{CMAKE_PROPERTY_LIST})
    get_target_property(propval ${real_target} ${prop})
    if (propval)
  ...
  if(NOT ("" STREQUAL PROP_LIST))
    ...
    message(STATUS "No properties found for target `${target}`.")
  endif()
