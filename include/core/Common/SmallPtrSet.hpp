...
#include <core/Common/ADL.hpp>
#include <core/Common/EpochTracker.hpp>
#include <core/Common/STLForwardCompat.hpp>
#include <core/Common/iterator_range.hpp>
#include <core/Support/Alloc.hpp>
#include <core/Support/ErrorHandle.hpp>
#include <core/Support/MathExtras.hpp>
#include <core/Support/ReverseIteration.hpp>
#include <core/Support/type_traits.hpp>
#include <algorithm>
#include <cassert>
#include <cstddef>
#include <cstdlib>
...
protected:
  ...
  explicit SmallPtrSetImplBase(const void **SmallStorage, unsigned SmallSize)
      : CurArray(SmallStorage), CurArraySize(SmallSize), NumEntries(0),
        IsSmall(true) {
    exi_assert(exi::has_single_bit(SmallSize),
...
protected:
  ...
  void copyFrom(const void **SmallStorage,
...
class EXI_DEBUGEPOCHBASE_HANDLEBASE_EMPTYBASE SmallPtrSetIteratorImpl
...
protected:
  void *dereference() const {
    exi_assert(isHandleInSync(), "invalid iterator access!");
    exi_assert(Bucket < End);
...
class SmallPtrSet : public SmallPtrSetImpl<PtrType> {
  ...
  static constexpr size_t SmallSizePowTwo = exi::bit_ceil_constexpr(SmallSize);
...
public:
  ...
  SmallPtrSet(exi::from_range_t, Range &&R)
...
inline void swap(exi::SmallPtrSet<T, N> &LHS, exi::SmallPtrSet<T, N> &RHS) {
  LHS.swap(RHS);
}
