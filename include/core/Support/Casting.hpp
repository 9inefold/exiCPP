...
template <class To, class From>
using cast_retty_t = typename cast_retty<To, From>::ret_type;
...
template <class To, class FromTy> struct cast_convert_val<To, FromTy, FromTy> {
  ...
  static typename cast_retty<To, FromTy>::ret_type doit(const FromTy &Val) {
    return *(std::remove_reference_t<cast_retty_t<To, FromTy>>
...
struct cast_convert_val<To, FromTy *, FromTy *> {
  ...
  static cast_retty_t<To, FromTy *> doit(const FromTy *Val) {
    return (cast_retty_t<To, FromTy *>) const_cast<FromTy *>(Val);
  }
};
...
struct ValueFromPointerCast
    : public CastIsPossible<To, From *>,
      ...
      public DefaultDoCastIfPossible<
          To, From *,
          H::SelfType<Derived, ValueFromPointerCast<To, From>>> {
...
[[nodiscard]] inline auto cast_if_present(const Y &Val) {
  ...
  return cast<X>(H::unwrapValue(Val));
}
...
template <class X, class Y> auto dyn_cast_if_present(const Y &Val) {
  if (!H::isPresent(Val))
    return CastInfo<X, const Y>::castFailed();
  return CastInfo<X, const Y>::doCastIfPossible(H::unwrapValue(Val));
}

template <class X, class Y> auto dyn_cast_if_present(Y &Val) {
  if (!H::isPresent(Val))
    return CastInfo<X, Y>::castFailed();
  return CastInfo<X, Y>::doCastIfPossible(H::unwrapValue(Val));
}
...
/// algorithms such as `exi::all_of`, `exi::none_of`, etc. This is accomplished
...
/// Function object wrapper for the `exi::isa` type check. The function call
/// operator returns true when the value can be cast to any type in `Types`.
/// Example:
/// ```
/// SmallVector<Type> myTypes = ...;
/// if (exi::all_of(myTypes, exi::IsaPred<VectorType>))
///   ...
/// ```
template <typename... Types>
inline constexpr H::IsaCheckPredicate<Types...> IsaPred{};

/// Function object wrapper for the `exi::isa_and_present` type check. The
...
/// ```
/// SmallVector<Type> myTypes = ...;
/// if (exi::all_of(myTypes, exi::IsaAndPresentPred<VectorType>))
///   ...
/// ```
template <typename... Types>
