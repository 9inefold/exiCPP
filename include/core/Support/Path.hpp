...
//===----------------------------------------------------------------===//
//
// This file declares the exi::sys::path namespace. It is designed after
...
class const_iterator
    : public iterator_facade_base<const_iterator, std::input_iterator_tag,
                                  const StrRef> {
  StrRef Path;          ///< The entire path.
  StrRef Component;     ///< The current component. Not necessarily in Path.
  usize  Position = 0;  ///< The iterators current position within Path.
  Style S = Style::native; ///< The path style to use.

  // An end iterator has Position = Path.size() + 1.
  friend const_iterator begin(StrRef path, Style style);
  friend const_iterator end(StrRef path);
...
class reverse_iterator
  ...
  friend reverse_iterator rbegin(StrRef path, Style style);
  friend reverse_iterator rend(StrRef path);
...
const_iterator begin(StrRef path, Style style = Style::native);
...
reverse_iterator rbegin(StrRef path, Style style = Style::native);
...
StrRef remove_leading_dotslash(StrRef path, Style style = Style::native);
...
bool remove_dots(SmallVecImpl<char> &path, bool remove_dot_dot = false,
                 Style style = Style::native);
...
void append(SmallVecImpl<char> &path, const Twine &a,
                                      const Twine &b = "",
                                      const Twine &c = "",
                                      const Twine &d = "");
...
void native(const Twine &path, SmallVecImpl<char> &result,
            Style style = Style::native);
...
///
/// @param path A path that is transformed to native format.
void native(SmallVecImpl<char> &path, Style style = Style::native);

/// For Windows path styles, convert path to use the preferred path separators.
/// For other styles, do nothing.
///
/// @param path A path that is transformed to preferred format.
inline void make_preferred(SmallVecImpl<char> &path,
                           Style style = Style::native) {
...
/// chracters.
String convert_to_slash(StrRef path, Style style = Style::native);
...
StrRef root_name(StrRef path, Style style = Style::native);
...
///               "".
StrRef root_directory(StrRef path, Style style = Style::native);
...
StrRef root_path(StrRef path, Style style = Style::native);
...
StrRef relative_path(StrRef path, Style style = Style::native);
...
StrRef parent_path(StrRef path, Style style = Style::native);
...
StrRef filename(StrRef path, Style style = Style::native);
...
StrRef stem(StrRef path, Style style = Style::native);
...
StrRef extension(StrRef path, Style style = Style::native);
...
///
/// @result StrRef of the preferred separator, null-terminated.
StrRef get_separator(Style style = Style::native);
...
void system_temp_directory(bool erasedOnReboot, SmallVecImpl<char> &result);

/// Get the user's home directory.
///
/// @param result Holds the resulting path name.
/// @result True if a home directory is set, false otherwise.
bool home_directory(SmallVecImpl<char> &result);
...
bool user_config_directory(SmallVecImpl<char> &result);
...
/// @param result Holds the resulting path name.
/// @result True if the appropriate path was determined, it need not exist.
bool cache_directory(SmallVecImpl<char> &result);
