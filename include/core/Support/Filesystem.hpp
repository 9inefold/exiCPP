...
//===----------------------------------------------------------------===//
//
// This file declares the exi::sys::fs namespace. It is designed after
...
public:
  ...
  /// resolution is an implementation H of the underlying file system.
...
class directory_iterator {
  std::shared_ptr<H::DirIterState> State;
